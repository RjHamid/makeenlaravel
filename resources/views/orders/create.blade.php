...
@csrf
        <div class="mb-3 mt-3">
          <label for="name" class="form-label">سفارشات :</label>
          <input type="text" class="form-control" id="name" name="orders_table" placeholder="نام  را وارد کنید" >
        </div>
      <div class="mb-3 mt-3">
